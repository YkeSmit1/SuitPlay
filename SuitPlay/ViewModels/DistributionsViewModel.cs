...
public partial class DistributionsViewModel : ObservableObject, IQueryAttributable
{
    ...
    [ObservableProperty] public partial ObservableCollection<Cards> AllPlays { get; set; }
    ...
    public void ApplyQueryAttributes(IDictionary<string, object> query)
    {
        ...
        AllPlays = new ObservableCollection<Cards>(result.AllPlays.Where(x => x.Count() == 3));
